...
> 更多 Spring Boot 实战项目可以关注十三的另一个代码仓库 [spring-boot-projects](https://github.com/HowlingFox/Personal_Blog/spring-boot-projects)，该仓库中主要是 Spring Boot 的入门学习教程以及一些常用的 Spring Boot 实战项目教程，包括 Spring Boot 使用的各种示例代码，同时也包括一些实战项目的项目源码和效果展示，实战项目包括基本的 web 开发以及目前大家普遍使用的前后端分离实践项目等，后续会根据大家的反馈继续增加一些实战项目源码，摆脱各种 hello world 入门案例的束缚，真正的掌握 Spring Boot 开发。
...
- **layui 版本的 My-Blog，仓库地址 [My-Blog-layui](https://github.com/HowlingFox/Personal_Blog/My-Blog-layui) ，感兴趣的朋友也可以学习一下；**
...
[![License](https://img.shields.io/badge/license-apache-blue.svg)](https://github.com/HowlingFox/Personal_Blog/My-Blog/blob/master/LICENSE)
...
> 大家有任何问题或者建议都可以在 [issues](https://github.com/HowlingFox/Personal_Blog/My-Blog/issues) 中反馈给我，我会慢慢完善这个项目。
...
- [My-Blog in GitHub](https://github.com/HowlingFox/Personal_Blog/My-Blog)

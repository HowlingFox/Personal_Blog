...
insert  into `tb_config`(`config_name`,`config_value`,`create_time`,`update_time`) values ('footerPoweredBy','https://github.com/HowlingFox/Personal_Blog','2018-11-11 20:33:36','2018-11-12 11:58:06');
insert  into `tb_config`(`config_name`,`config_value`,`create_time`,`update_time`) values ('footerPoweredByURL','https://github.com/HowlingFox/Personal_Blog','2018-11-11 20:33:39','2018-11-12 11:58:06');
...
insert  into `tb_link`(`link_id`,`link_type`,`link_name`,`link_url`,`link_description`,`link_rank`,`is_deleted`,`create_time`) values (2,2,'十三的GitHub','https://github.com/HowlingFox/Personal_Blog','十三分享代码的地方',1,0,'2018-10-22 19:41:04');

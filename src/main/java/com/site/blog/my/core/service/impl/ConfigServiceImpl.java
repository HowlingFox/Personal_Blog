...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String yourEmail = "3418427916@qq.com";
    public static final String yourName = "杰爸爸";

    public static final String footerAbout = "your personal blog. have fun.";
    public static final String footerICP = "沪ICP备 20210900-318号";
    public static final String footerCopyRight = "@2022 blog";
